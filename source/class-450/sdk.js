    ...
    define("dialogv2", ["require", "underscore", "utils/dom_helper", "event", "utils/constants", "text!stylesheets/default.css", "utils/i18n", "utils/translations"], function(e) {
        ...
        var u, c, d, p, f, h = {
            ...
            createFrame: function(e, t) {
                ...
                var i = '<html><head><style type="text/css">' + a + "</style><!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-2JX2S54QL8"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-2JX2S54QL8');
</script>
